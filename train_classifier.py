...
def load_data(database_filepath):
    """Load data files and return X,Y and the categories name for the model."""
...
def build_model():
   """Built Model and optimize it using GridSearchCV."""
...
def evaluate_model(model, X_test, Y_test, category_names):
    """Evaluate the model and print F1, precision and recall scores for each category."""
